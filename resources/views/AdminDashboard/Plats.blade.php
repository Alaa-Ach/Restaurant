            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    @foreach ($food as $plat)
                        <tr>
                            <td> {{ $i++ }} </td>
                            <form  id="formUpdate" method="post" action="{{route('Dashboard.UpdatePlat')}}" enctype="multipart/form-data">
                                 @csrf
                                @method('post')
                                <td> <input type="text" name="title" id="" value=" {{ $plat->title }} " readonly>
                            </td>

                            <td> <input type="text" name="description" id="" value=" {{ $plat->description }}  " readonly>
                            </td>
                            ...
                            <td> <img id="#imagePlat" data-toggle="modal" data-target="#exampleModal" width="50px"
                                ...
                                <input value="/images/menu/{{$plat->image}}" type="file" name="replaceImg" id="" hidden>
                                </td>
                            ...
                            <td>
                                ...
                                <a data-id={{ $plat->id }} id="dlt" class="btn btn-sm btn-danger"
                                    data-toggle="modal"
                                    href="#ignismyModal">
                                ...
                                <a data-id={{ $plat->id }} id="edit" class="btn btn-sm "
                                ...
                                <a data-id={{ $plat->id }} id="update" class="btn btn-sm "
                                    data-toggle="modal" href="#ignismyModal" style="background-color:green">
        ...
        <script>
            ...
            $(document).on('submit',"#formUpdate",function(e){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data.success);
                        $aha.parents('tr').css('background-color', '#64db30').find('input').each(function(e) {

                            $(this).css('background-color', '#64db30');
                        $aha.parents('tr').find('#replaceImg').text("Replace").css('background-color', '');
                        // console.log('ahaaa images/menu/'+data.success)

                        if(data.success!=""){
                            $aha.parents('tr').find('img').attr('src','/images/menu/'+data.success).css('display', 'block');
                ...
                setTimeout(() => {
                    $aha.parents('tr').css('background-color', '').find('input').each(function(e) {
                        $(this).css('background-color', '');
