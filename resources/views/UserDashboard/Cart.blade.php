                                    ...
                                    @foreach (Auth::user()->Cart as $cart)
                                        <tr>
                                            ...
                                            <form id="formUpdate" method="post"
                                                ...
                                                <td> <input min=0 type="number" id-Plat="{{ $cart->food->id }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="CheckOutCollapse">
                                <div class="card card-body">
                                    ...
                                    <form id="FormOrder" action="{{Route('OrderNow')}}" method="post" enctype="multipart/form-data" method="post" >
                                        @csrf
                                        @method('post')
                                        <div class="form-row">
                                        ...
                                        <div class="form-row ">
                                            ...
                                            <div class="form-group col-md-2  " >
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <input readonly type="text" class="form-control" name="totalOrder" id="totalOrder">
    ...
    $('document').ready(function() {
       ...
       function CheckRow(){
           ...
           if(rowCount == 0) {
               ...
               $('#CheckOutCollapse .card').css({"min-height":"auto","text-align":"center"});
